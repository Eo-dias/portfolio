              ...
              <AnimatePresence>
                ...
                {status === 'error' && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0, scale: 1 }}
                    exit={{ opacity: 0, y: -10, scale: 0.95 }}
                    className="w-full sm:w-auto p-4 rounded-radius-lg bg-red-500/10 border border-red-500/30 text-red-400 flex items-center gap-3"
                    role="alert"
                    aria-live="assertive"
                  >
                    ...
                    <span className="text-body-sm font-medium">Erro ao enviar. Tente novamente ou me chame direto no email.</span>
                  </motion.div>
                )}
              </AnimatePresence>
            </form>
